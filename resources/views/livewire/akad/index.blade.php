<div>
    <x-slot name="title">Akad Pinjaman</x-slot>

    <x-slot name="pagePretitle">Akad Pinjaman</x-slot>

    <x-slot name="pageTitle">Akad Pinjaman</x-slot>
            ...
            <table class="table card-table table-bordered datatable">
                <thead>
                    <tr>
                        ...
                        <th>
                            <x-datatable.column-sort name="Status Akad" wire:click="sortBy('status_akad')" :direction="$sorts['status_akad'] ?? null" />
                        </th>
                    ...
                    @forelse ($this->rows as $row)
                        <tr wire:key="row-{{ $row->id }}">
                            ...
                            <td>
                                <div class="d-flex">
                                    <div class="ms-auto">
                                        <a href="{{ route('akad.pinjaman.agreement', $row->id) }}" class="btn btn-{{ $row->status_akad == 'di berikan' ? 'success-lt' : 'success' }}">{{ $row->status_akad != 'di berikan' ? 'Berikan Akad Pinjaman' : 'Lihat Akad Pinjaman' }}</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
